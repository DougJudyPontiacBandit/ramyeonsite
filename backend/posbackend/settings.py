"""
Django settings for ramyeon backend project.
"""
...
try:
    ...
    print(f"✅ Connected to MongoDB Atlas: {MONGODB_DATABASE}")
except Exception as e:
    print(f"❌ MongoDB connection failed: {e}")

# Django still needs a SQL database for some built-in features (sessions, admin)
DATABASES = {
    'default': {
