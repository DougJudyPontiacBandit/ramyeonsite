...
class CustomerService:
    def __init__(self):
        ...
        if self.db is None:
            raise Exception("Database connection failed. Please check your MongoDB Atlas connection.")
    ...
    def create_customer(self, customer_data, current_user=None):
        ...
        try:
            ...
            import uuid
            qr_code = f"CUST-{customer_id[:8]}-{str(uuid.uuid4())[:8]}".upper()
    ...
    def regenerate_qr_code(self, customer_id, current_user=None):
        ...
        try:
            ...
            import uuid
            new_qr_code = f"CUST-{customer_id[:8]}-{str(uuid.uuid4())[:8]}".upper()
