...
class DatabaseManager:
    ...
    def connect_to_cloud(self):
        ...
        try:
            uri = config('MONGODB_URI', default='mongodb+srv://admin:ISZxn6AfY8wLSz2O@cluster0.qumhbyz.mongodb.net/pos_system?retryWrites=true&w=majority')
    ...
    def get_database(self):
        ...
        # If no connection, return None for mock mode
        logger.warning("No database connection available, running in mock mode")
        return None
